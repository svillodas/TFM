...
La monitorización de la condición de una máquina rotativa se apoya en un conjunto de indicadores
...
distribución de las amplitudes, cuantifica la impulsividad de la señal y no su magnitud, con lo
...
Los trabajos revisados abordan por separado las tres cuestiones que este TFM integra: los
...
práctica de este TFM resultó ser la determinante. Los métodos de monitorización de
