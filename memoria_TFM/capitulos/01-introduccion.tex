...
inteligencia artificial en el extremo (\textit{Edge Computing}). A partir de las necesidades
...
del sistema. En este último se justifican las decisiones técnicas adoptadas tanto a nivel de
...
El documento concluye con una serie de anexos técnicos que completan la información detallada
sobre la instrumentación y construcción del sistema.
