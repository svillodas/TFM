...
consecuencia física esperable de la perturbación. Su manifestación más elocuente es la duración
de la marcha, que alcanzó \textbf{130 min} frente a una mediana nominal de \mbox{31 min}.

Y el detector lo señaló con una progresión que la tabla hace evidente. En la primera media hora
marcó 10 de 45 ráfagas; en la hora siguiente, con el diferencial ya \mbox{9,4 °C} por encima de
la referencia, marcó \textbf{108 de 111}, y la racha de anomalías consecutivas alcanzó 61. No es
una reacción esporádica sino una \textbf{detección sostenida}.
...
Procede consignar una reserva que subsiste: el activo ya presentaba un diferencial elevado antes
de la apertura por llevar treinta y siete minutos de marcha continua, circunstancia que impide
separar limpiamente el efecto de la perturbación del de la marcha prolongada previa.

\section{Un defecto de la política de avisos y su evaluación sin modificar el firmware}

El episodio produjo \textbf{cuatro avisos para un solo suceso}. La causa es que la histéresis
...
Debe consignarse que se descartó una primera propuesta. Exigir varias ráfagas \textit{nominales}
consecutivas para rearmar no reduce los avisos —14, 16 y 19 según el valor, frente a los 18 de la
política actual— porque al no romper la racha con una nominal aislada, la racha de anomalías se
acumula con mayor rapidez y el aviso se dispara antes. La propuesta era incorrecta y la medición
...
un silencio de \mbox{120 min} abarca más de un ciclo completo, de modo que el valor no es
trasladable a otro activo sin repetir la medida sobre el suyo. Es por tanto una decisión de
...
significase algo distinto antes y después del cambio, introduciendo una discontinuidad en un
registro que hasta ahora es homogéneo.
