...
ESP32-S3 en la campaña EXP-007 (21,56~h de operación ininterrumpida).
...
Tras flashear el firmware en el nodo físico y desplegar la captura continua durante 21,56~h
(campaña EXP-007), se contrastaron las 913 ráfagas evaluables medidas en la placa con el
recálculo idéntico en el servidor. El resultado ratifica la paridad: \textbf{908 de 913 veredictos
coincidentes (99,45~\%)} y una diferencia mediana en la puntuación de apenas \mbox{0,00134}. Las
únicas 5 discrepancias registradas (0,55~\%) corresponden a observaciones situadas en la
frontera inmediata del umbral de decisión (distancia al umbral de 0,00124 frente a un error
máximo de 0,132), donde pequeñas divergencias de precisión en coma flotante determinan el corte.
La afirmación de que el diagnóstico predictivo se ejecuta en el nodo queda por tanto
\textbf{medida experimentalmente en hardware} y no supuesta.
