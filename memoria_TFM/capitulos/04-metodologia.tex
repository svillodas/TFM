...
% TODO: incorporar el resultado de la campaña de captura del estado nominal (duración,
% número de ráfagas válidas y descartadas). Requiere ejecutar la campaña: a fecha de
% redacción no existe ninguna registrada en docs/EXPERIMENTOS.md.

Las fases que siguen no se habían ejecutado en el momento de redactar este capítulo. Se
describe el protocolo establecido para cada una, dado que su definición condiciona el diseño
ya implementado; los resultados se recogerán en el capítulo~\ref{cap:resultados}.
...
% TODO: incorporar los resultados de las fases 6, 7 y 8 cuando se ejecuten. A fecha de
% redacción no existe ninguna campaña registrada en docs/EXPERIMENTOS.md, por lo que este
% capítulo describe el protocolo establecido y no resultados obtenidos.
